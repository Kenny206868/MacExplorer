...
struct FileGridView: View {
    ...
    private var itemHeight: CGFloat {
        switch tab.options.view { case .small: return 36; case .tiles, .details: return 80; default: return CGFloat(tab.options.view.iconSize) + 63 }
    }
    var body: some View {
        ScrollViewReader { proxy in
            GeometryReader { viewport in
                ...
                ScrollView {
                    ...
                    .padding(18).frame(maxWidth: .infinity, minHeight: viewport.size.height, alignment: .topLeading)
