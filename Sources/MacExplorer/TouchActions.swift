...
struct KeyboardHelpView: View {
    ...
    private let shortcuts: [(String, String)] = [
        ...
        ("F6 / Shift + F6", "Native profile: cycle location, search, and file focus"),
        ("F2 / Return / Escape", "Edit a file name / Commit rename / Cancel rename"),
        ("F3 / F4 / F5", "Native profile: Search / Location / Refresh"),
        ("Commander F3 / F4 / F5", "Opt-in: View / TextEdit / Copy to other pane"),
        ("Commander F6 / F7 / F8", "Opt-in: Move / New Folder / Trash (file focus only)"),
