...
MANIFESTS = ('captures.json', 'archive-captures.json', 'design-captures.json', 'dual-captures.json', 'settings-captures.json')
CASES = {'extra-large-icons', 'large-icons', 'medium-icons', 'small-icons', 'list', 'details',
         ...
         'touch-file-actions', 'keyboard-help', 'settings-appearance', 'settings-input', 'settings-integration', 'settings-updates'}
...
def validate(root: pathlib.Path) -> dict:
    ...
    report = {'schemaVersion': 4, 'captures': len(captures), 'sha256': checksums,
