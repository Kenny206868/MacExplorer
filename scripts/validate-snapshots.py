...
MANIFESTS = ('captures.json', 'archive-captures.json', 'design-captures.json', 'dual-captures.json', 'settings-captures.json', 'inline-captures.json', 'command-captures.json')
CASES = {'extra-large-icons', 'large-icons', 'medium-icons', 'small-icons', 'list', 'details',
         ...
         'touch-file-actions', 'keyboard-help', 'settings-appearance', 'settings-input', 'settings-integration', 'settings-updates', 'inline-rename', 'commands', 'commands-search', 'commands-disabled', 'commands-empty'}
...
def validate(root: pathlib.Path) -> dict:
    ...
    report = {'schemaVersion': 6, 'captures': len(captures), 'sha256': checksums,
              'checks': ['coverage', 'PNG dimensions', 'nonblank rendering', 'opaque sRGB compositing',
                         ...
                         'responsive orientation intent', 'touch and keyboard action coverage', 'all settings pages', 'native inline filename editor', 'searchable command palette and native search focus']}
